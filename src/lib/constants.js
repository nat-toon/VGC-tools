...
export const MOVES_CACHE_VERSION = 1;
export const LEARNSETS_CACHE_VERSION = 2;

export const REG_KEY = "pkmn_last_reg";
export const CACHE_KEY = "pkmn_pokedex_v10";
export const MOVES_CACHE_KEY = "pkmn_moves_v1";
